  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(6) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `tasks` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `priority` TEXT NOT NULL, `deadline` INTEGER NOT NULL, `status` TEXT NOT NULL, `description` TEXT NOT NULL, `category` TEXT NOT NULL, `hasImage` INTEGER NOT NULL, `predecessorIds` TEXT NOT NULL, `relatedIds` TEXT NOT NULL, `richContent` TEXT NOT NULL, `sortOrder` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, `completedAt` INTEGER)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e37e7536ccb5f5b639b55b77edde9fdd')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsTasks.put("hasImage", new TableInfo.Column("hasImage", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTasks.put("predecessorIds", new TableInfo.Column("predecessorIds", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTasks.put("relatedIds", new TableInfo.Column("relatedIds", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTasks.put("richContent", new TableInfo.Column("richContent", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoTasks.equals(_existingTasks)) {
          return new RoomOpenHelper.ValidationResult(false, "tasks(com.ledger.task.data.local.TaskEntity).\n"
                  + " Expected:\n" + _infoTasks + "\n"
                  + " Found:\n" + _existingTasks);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e37e7536ccb5f5b639b55b77edde9fdd", "4b3169b0088778439e2933e2583eac81");
